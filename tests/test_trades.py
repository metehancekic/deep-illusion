...
from deepillusion.torchdefenses import trades_epoch
...
trades_args = dict(eps=attack_params["eps"],
...
for epoch in range(1, epochs + 1):
    ...
    print(f'Trades train \t loss: {train_loss:.4f} \t acc: {train_acc:.4f}\t duration {end_time-start_time:.1f} seconds')
